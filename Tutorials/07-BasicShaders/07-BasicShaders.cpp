...
{
    // Compile the shader
    ID3DBlobPtr pRayGenShader = compileLibrary(L"Data/07-Shaders.hlsl", L"lib_6_1");
...
{
    // Need 12 subobjects:
    //  1 for RayGen program
    //  1 for Miss Program
    //  2 for hit-program (CHS and hit-group)
...
int WINAPI WinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPSTR lpCmdLine, _In_ int nShowCmd)
{
    ...
    SampleConfig config;
    config.windowDesc.title = "Tutorial 07 - Basic Shaders";
